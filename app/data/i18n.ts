...
export const siteCopy: Record<Language, SiteCopy> = {
  pt: {
    ...
    footer: "Lucas + OLI · Games, tecnologia e cultura geek e pop",
    home: {
      pageTitle: "Lucas de Oliveira Andrade + OLI — Games, tecnologia e cultura geek e pop",
      regions: "São Paulo · Brasil",
      heroEyebrow: "Portfólio pessoal de carreira",
      heroName: "Lucas de Oliveira Andrade",
      heroTitle: "Estratégia e marketing para games, tecnologia e cultura geek e pop.",
      heroText: "Desde 2010, atuo na Rico Games — das vendas e do atendimento ao comercial, ao marketing e à gerência. Com a OLI, conecto essa vivência à criação de marcas, ofertas, conteúdos e experiências digitais.",
      positioning: "Conecto pontos que parecem não ter relação e transformo em uma direção que funciona.",
      journeyCta: "Conheça minha atuação",
      ...
      summaryEyebrow: "Repertório de quem está dentro",
      summaryTitle: "Antes da campanha, o balcão.",
      summaryText: "Minha base está na operação: entender dúvidas, lidar com objeções, avaliar produtos e construir ofertas. Esse contato com clientes e com o negócio orienta minha atuação em gestão, marketing e criação. Games, tecnologia e cultura geek e pop são o foco; as experiências em outros setores ampliam meu repertório.",
      summaryCta: "Percorrer minha trajetória",
      companiesIndex: "03 / Experiências",
      companiesEyebrow: "A experiência por trás do foco",
      companiesTitle: "Da operação à marca",
      companiesText: "Vendas, gestão, conteúdo, processos e criação: quatro experiências que mostram como participo do negócio. A trajetória completa permanece no arquivo.",
      companiesCta: "Ver todas as experiências",
      careerCardCta: "Ver minha atuação",
      worksIndex: "04 / Projetos",
      worksEyebrow: "Games, tecnologia e cultura pop na prática",
      worksTitle: "Direção que ganha forma",
      worksText: "Marcas, comunicação comercial e presença digital para games, eletrônicos e cultura geek e pop. Cada projeto mantém seu status real: consultoria, realizado ou em desenvolvimento.",
      worksCta: "Explorar todos os trabalhos",
      projectCardCta: "Ver trabalho",
      partnershipsIndex: "05 / Parcerias",
      partnershipsEyebrow: "Ações e ativações",
      partnershipsTitle: "Parcerias, ações e ativações",
      partnershipsText: "Marcas, canais, artistas e eventos presentes em ações das quais participei no contexto da Rico Games. São relações dessa atuação — não uma lista de clientes pessoais ou de parceiros oficiais da OLI.",
      partnershipNames: ["PlayStation", "Flow", "Flow Games", "4 Amigos", "Afonso Padilha", "David Jones", "Canal Peewee", "BGS"],
      valueIndex: "06 / Como posso contribuir",
      valueEyebrow: "Estratégia conectada à execução",
      valueTitle: "O produto, o público e o negócio na mesma conversa.",
      valueText: "Meu trabalho está em entender o que a empresa oferece, como atende e como se comunica. A partir disso, conecto decisões comerciais e execução criativa.",
      valueAxes: [
        { number: "01", title: "Oferta e estratégia comercial", text: "Conecto dúvidas do cliente, características do produto e oportunidade comercial para estruturar ofertas, argumentos de venda e campanhas.", tags: ["Negócios", "Vendas", "Posicionamento"] },
        { number: "02", title: "Operação e experiência do cliente", text: "Analiso atendimento, comunicação e processos para aproximar o que a marca promete da experiência que o cliente encontra.", tags: ["Gestão", "Processos", "Operação"] },
        { number: "03", title: "Conteúdo e lançamentos", text: "Planejo campanhas, produzo e apresento vídeos e lives. Traduzo produto e contexto em conteúdo com intenção comercial.", tags: ["Marketing", "Campanhas", "Audiovisual"] },
        { number: "04", title: "Marca, sites e e-commerce", text: "Desenvolvo posicionamento, identidade e presença digital para organizar a oferta e tornar a jornada de informação, compra ou contato mais clara.", tags: ["Marca", "Sites", "E-commerce"] },
      ...
      contactEyebrow: "Converse diretamente comigo",
      contactTitle: "Qual é o próximo desafio do seu negócio?",
      contactText: "Se você atua em games, tecnologia ou cultura geek e pop e precisa conectar estratégia, marketing e execução, vamos conversar. Também estou aberto a oportunidades profissionais e colaborações alinhadas à minha experiência.",
    ...
    index: {
      ...
      title: "Projetos",
      text: "Games, tecnologia e cultura geek e pop abrem a seleção. Trabalhos de outros setores completam meu repertório em marca, comunicação e presença digital — sempre com minha atuação e o estágio real de cada projeto.",
    },
...
const caseTranslations: Record<"en" | "ru", Record<string, CaseTranslation>> = {
  en: {
    ...
    "rico-games": {
      ...
      built: "Visual direction, color system, campaign templates and commercial content in development.",
      ...
      deliverables: ["Visual direction", "Brand application direction", "Color system", "Campaign templates", "Sales content"],
    ...
    "manifesto-bar": {
      sector: "Entertainment · rock", location: "São Paulo · Brazil", status: "Navigable digital concept", headline: "Where rock lives in Brazil.",
      summary: "A cinematic digital concept exploring how history, programming and identity could form a coherent experience for Manifesto Bar.",
      personalRole: "Within my communication and marketing consulting work, I developed a conceptual digital experience for the venue.",
      built: "Information architecture, cinematic visual direction, homepage, schedule and artist-archive concepts in a navigable responsive prototype.",
      challenge: "Explore how decades of memory and live energy could become a contemporary navigation experience without losing the raw force of rock.",
      direction: "As a concept study, I connected stage imagery, smoke, aged gold, black and motion in a journey through programming, history and visiting information.",
      result: "The prototype demonstrates one possible direction and is presented as a navigable concept, not as a commissioned official website.",
      services: ["Communication consulting", "Digital strategy", "UX/UI", "Art direction"],
      deliverables: ["Information architecture", "Cinematic visual direction", "Homepage concept", "Schedule concept", "Artist-archive concept", "Navigable responsive prototype"],
      cover: { alt: "Stage used as context for the Manifesto Bar digital concept", label: "Venue atmosphere reference" },
      gallery: [{ alt: "Manifesto Bar interior", label: "Venue context" }, { alt: "Event used as a programming reference", label: "Programming reference" }, { alt: "Manifesto Bar symbol", label: "Brand context" }],
    },
    "metro-case": {
  ...
  ru: {
    ...
    "rico-games": {
      ...
      built: "Визуальное направление, цветовая система, шаблоны кампаний и коммерческий контент в разработке.",
      ...
      deliverables: ["Визуальное направление", "Направление применения бренда", "Цветовая система", "Шаблоны кампаний", "Коммерческий контент"],
    ...
    "manifesto-bar": {
      sector: "Развлечения · рок", location: "Сан-Паулу · Бразилия", status: "Навигационный digital-концепт", headline: "Место, где живёт рок Бразилии.",
      summary: "Кинематографичный digital-концепт о том, как история, программа и айдентика могут формировать целостный опыт Manifesto Bar.",
      personalRole: "В рамках консалтинга по коммуникациям и маркетингу я разработал концептуальный цифровой опыт для площадки.",
      built: "Информационная архитектура, кинематографичное визуальное направление, концепции главной страницы, программы и архива артистов в адаптивном навигационном прототипе.",
      challenge: "Исследовать, как десятилетия истории и энергия живых выступлений могут получить современную навигацию, сохранив силу рока.",
      direction: "В концептуальном исследовании я связал сцену, дым, состаренное золото, чёрный цвет и движение с программой, историей и информацией для посетителей.",
      result: "Прототип показывает одно из возможных направлений и представлен как навигационный концепт, а не официальный заказной сайт.",
      services: ["Консалтинг по коммуникациям", "Цифровая стратегия", "UX/UI", "Арт-дирекшн"],
      deliverables: ["Информационная архитектура", "Кинематографичное визуальное направление", "Концепция главной страницы", "Концепция программы", "Концепция архива артистов", "Навигационный адаптивный прототип"],
      cover: { alt: "Сцена как контекст для digital-концепта Manifesto Bar", label: "Атмосфера площадки" },
      gallery: [{ alt: "Интерьер Manifesto Bar", label: "Контекст площадки" }, { alt: "Событие как референс программы", label: "Референс программы" }, { alt: "Символ Manifesto Bar", label: "Контекст бренда" }],
    },
    "metro-case": {
