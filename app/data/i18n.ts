...
export const siteCopy: Record<Language, SiteCopy> = {
  pt: {
    ...
    home: {
      pageTitle: "OLI — Identidade visual e sites que posicionam",
      studio: "Estúdio criativo",
      regions: "Brasil — Portugal",
      kicker: "Estratégia · identidade · digital",
      heroTitle: "Marcas que não passam",
      heroAccent: "despercebidas.",
      lede: "Transformamos bons negócios em presenças que inspiram confiança, despertam desejo e deixam mais fácil dizer “sim”.",
      ...
      portfolioIndex: "02 / Portfólio por empresa",
      portfolioEyebrow: "Clique. Entre. Explore.",
      projectsTitle: "Projetos",
      portfolioText: "Cada negócio abre uma história completa: contexto, direção, entregas e o trabalho ganhando forma em marca, conteúdo ou experiência digital.",
  ...
  en: {
    ...
    home: {
      pageTitle: "OLI — Visual identities and websites that position brands",
      studio: "Creative studio",
      regions: "Brazil — Portugal",
      kicker: "Strategy · identity · digital",
      heroTitle: "Brands that never go",
      heroAccent: "unnoticed.",
      lede: "We turn strong businesses into brands that inspire trust, create desire and make saying “yes” easier.",
      ...
      portfolioIndex: "02 / Portfolio by company",
      portfolioEyebrow: "Click. Enter. Explore.",
      projectsTitle: "Projects",
      portfolioText: "Each company opens a complete story: context, direction, deliverables and the work taking shape as a brand, content or digital experience.",
  ...
  ru: {
    ...
    home: {
      pageTitle: "OLI — Айдентика и сайты, которые усиливают бренд",
      studio: "Креативная студия",
      regions: "Бразилия — Португалия",
      kicker: "Стратегия · айдентика · digital",
      heroTitle: "Бренды, которые",
      heroAccent: "невозможно не заметить.",
      lede: "Мы превращаем сильный бизнес в бренд, который вызывает доверие, формирует желание и облегчает решение сказать «да».",
      ...
      portfolioIndex: "02 / Портфолио по компаниям",
      portfolioEyebrow: "Нажмите. Войдите. Изучите.",
      projectsTitle: "Проекты",
      portfolioText: "За каждой компанией — цельная история: контекст, направление, результаты и воплощение работы в бренде, контенте или цифровом опыте.",
