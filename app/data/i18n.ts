...
export const siteCopy: Record<Language, SiteCopy> = {
  pt: {
    ...
    footer: "Lucas + OLI · Estratégia e marketing para games e tecnologia",
    home: {
      pageTitle: "Lucas de Oliveira Andrade + OLI — Games e tecnologia",
      regions: "São Paulo · Brasil",
      heroEyebrow: "Portfólio pessoal de carreira",
      heroName: "Lucas de Oliveira Andrade",
      heroTitle: "Estratégia, marketing e negócios para games e tecnologia.",
      ...
      summaryText: "Minha base está na operação: entender dúvidas, lidar com objeções, avaliar produtos e construir ofertas. Esse contato com clientes e com o negócio orienta minha atuação em gestão, marketing e criação. Games e tecnologia são o foco; as experiências em outros setores ampliam meu repertório.",
      ...
      worksEyebrow: "Games e tecnologia na prática",
      worksTitle: "Direção que ganha forma",
      worksText: "Marcas, comunicação comercial e presença digital para games, eletrônicos e serviços especializados. Cada projeto mantém seu status real: consultoria, realizado ou em desenvolvimento.",
      ...
      contactText: "Se você atua em games ou tecnologia e precisa conectar estratégia, marketing e execução, vamos conversar. Também estou aberto a oportunidades profissionais e colaborações alinhadas à minha experiência.",
    ...
    index: {
      ...
      title: "Projetos",
      text: "Games e tecnologia abrem a seleção. Trabalhos de outros setores completam meu repertório em marca, comunicação e presença digital — sempre com minha atuação e o estágio real de cada projeto.",
    },
