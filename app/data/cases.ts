...
export const cases: PortfolioCase[] = [
  ...
  },
  {
    ...
    services: ["Consultoria de comunicação", "Estratégia digital", "UX/UI", "Direção de arte"],
    deliverables: [
    ...
    cover: {
      ...
      height: 941,
      kind: "photo",
      alt: "Palco usado como referência visual no conceito digital do Manifesto Bar",
      label: "Referência de atmosfera da casa",
      placements: {
        card: {
          fit: "cover",
          position: "50% 53%",
        ...
        hero: {
          ...
          layout: "feature",
          mobile: {
            src: "/cases/manifesto/palco-mobile.webp",
            width: 820,
            height: 941,
            fit: "cover",
            position: "50% 50%",
    ...
    gallery: [
      ...
      },
      {
        ...
        label: "Material de programação da casa",
        placements: {
          gallery: {
            fit: "contain",
            position: "50% 50%",
      ...
      },
      {
        ...
        label: "Referência de marca da casa",
        placements: {
          gallery: {
            fit: "contain",
            position: "50% 50%",
    ...
    cover: {
      ...
      placements: {
        ...
        hero: {
          ...
          layout: "feature",
          mobile: {
            src: "/cases/oliveira-transportes/hero-mobile.webp",
            width: 820,
            height: 887,
            fit: "cover",
            position: "50% 50%",
  ...
  },
  {
    ...
    projectStatus: ProjectStatus.InDevelopment,
    personalRole:
      "Preservei a marca existente e desenvolvi uma proposta de direção criativa para organizar uma linguagem técnica e consistente.",
    built:
      "Vetorização do logo, estudos de sistema visual, cartão, conteúdo para Instagram, apresentação e conceito de site responsivo.",
    visible: true,
    ...
    result:
      "A proposta organiza marca, cartão, conteúdo e conceito digital sob a mesma lógica visual, registrada aqui como trabalho em desenvolvimento.",
    services: ["Identidade visual", "Sistema de marca", "Conteúdo", "Site"],
    deliverables: [
      "Direção criativa",
      "Vetorização fiel do logo",
      "Estudos de sistema visual",
      "Estudo de cartão e acabamento",
      "Kit inicial de Instagram",
    ...
    cover: {
      ...
      height: 1600,
      kind: "identity",
      alt: "Prévia de direção visual para a Eletrotech ISA",
      label: "Prévia de direção visual",
      fit: "contain",
      placements: {
        card: {
          fit: "contain",
  ...
  },
  {
    ...
    built:
      "Arquitetura conceitual do catálogo, direção visual, jornada de produto e conteúdo institucional em uma demonstração navegável.",
    visible: true,
    ...
    result:
      "A demonstração explora uma jornada possível do primeiro olhar à escolha da peça; produtos, preços, estoque e checkout permanecem ilustrativos.",
    ...
    deliverables: [
      ...
      "Demonstração responsiva navegável",
    ],
    cover: {
      ...
      height: 926,
      kind: "website",
      alt: "Demonstração conceitual de e-commerce para Dona Girafa",
      label: "Demonstração conceitual",
      position: "top center",
      placements: {
        card: {
          fit: "contain",
