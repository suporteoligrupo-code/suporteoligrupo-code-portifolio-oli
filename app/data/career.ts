...
export const careerUiCopy: Record<CareerLanguage, CareerUiCopy> = {
  pt: {
    index: {
      ...
      text: "Minha trajetória começa na Rico Games em 2010 e continua na operação. Games, tecnologia e cultura geek e pop estão em destaque; outros setores mostram a amplitude da minha experiência em gestão, marketing, consultoria e criação.",
      featuredLabel: "O foco da minha atuação",
      featuredTitle: "Games, tecnologia e cultura geek e pop",
      otherLabel: "Repertório complementar",
      otherTitle: "Outros setores, a mesma visão de negócio",
    },
    card: {
    ...
    page: {
      ...
      contactTitle: "Vamos conectar essa experiência ao seu negócio.",
